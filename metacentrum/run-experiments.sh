...
cp /storage/brno12-cerit/home/cernansky-jozef/LearnedMetricIndex/experiments/task1-inmemory.py inmemory.py || exit 4
cp /storage/brno12-cerit/home/cernansky-jozef/LearnedMetricIndex/task1.py base.py || exit 4
cp /storage/brno12-cerit/home/cernansky-jozef/LearnedMetricIndex/experiments/task1-compile.py compile.py || exit 4
cp /storage/brno12-cerit/home/cernansky-jozef/LearnedMetricIndex/experiments/task1-quant.py quant.py || exit 4
