# Adapted from https://github.com/Coda-Research-Group/LearnedMetricIndex/blob/paper-sisap24-indexing-challenge/task3.py
...
def task3(
    ...
    torch.save(
        lmi.bucket_data_ids,
        f'/storage/brno12-cerit/home/lickomar/sisap24-python/bucket_data_ids-t3-{dataset_size}.pt',
    )
    ...
    # for nprobe in [2]:
        ...
        with thread_lock_n_candidates:
            ...
            torch.save(
                ...
                f'/storage/brno12-cerit/home/lickomar/sisap24-python/n_candidates_per_query-t3-{dataset_size}-{nprobe}.pt',
            )

        utils.store_results(
            Path('/storage/brno12-cerit/home/lickomar/sisap24-python/result-n_candidates/')
            / 'task3'
            / dataset_size
            / f'{identifier}.h5',
            'lmi',
